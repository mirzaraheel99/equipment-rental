...
const PERMISSIONS = [
  ...
  {
    permissionCode: 'asset.master_data.manage',
    domainCode: 'asset',
    actionCode: 'manage',
    description: 'Create/update asset categories, manufacturers, equipment models, and asset locations.',
    riskLevel: 'medium',
    isPrivileged: false,
  },
  {
    ...
    domainCode: 'asset',
    actionCode: 'view',
    description: 'View assets, their history, meters, and documents.',
    riskLevel: 'low',
    isPrivileged: false,
  },
  {
    ...
    domainCode: 'asset',
    actionCode: 'create',
    description: 'Onboard a new asset.',
    riskLevel: 'medium',
    isPrivileged: false,
  },
  {
    ...
    domainCode: 'asset',
    actionCode: 'edit',
    description: 'Edit non-status, non-location asset fields.',
    riskLevel: 'medium',
    isPrivileged: false,
  },
  {
    permissionCode: 'asset.status.transition',
    domainCode: 'asset',
    actionCode: 'transition',
    description: 'Transition an asset through the Golden Rule status state machine.',
    riskLevel: 'high',
    isPrivileged: false,
  },
  {
    permissionCode: 'asset.status.override',
    domainCode: 'asset',
    actionCode: 'override',
    description: 'Bypass normal status transition rules — reserved for a future override endpoint.',
    riskLevel: 'critical',
    isPrivileged: true,
  },
  {
    permissionCode: 'asset.location.transfer',
    domainCode: 'asset',
    actionCode: 'transfer',
    description: 'Transfer an asset to a new authoritative location.',
    riskLevel: 'high',
    isPrivileged: false,
  },
  {
    permissionCode: 'asset.meter.enter',
    domainCode: 'asset',
    actionCode: 'enter',
    description: 'Create asset meters and record meter readings (manual or telematics).',
    riskLevel: 'low',
    isPrivileged: false,
  },
  {
    permissionCode: 'asset.document.upload',
    domainCode: 'asset',
    actionCode: 'upload',
    description: 'Link a Document/DocumentVersion to an asset (photos, manuals, certificates).',
    riskLevel: 'medium',
    isPrivileged: false,
  },
  {
    permissionCode: 'asset.document.verify',
    domainCode: 'asset',
    actionCode: 'verify',
    description: 'Mark an asset document/certificate as verified or rejected.',
    riskLevel: 'medium',
    isPrivileged: false,
  },
  {
    permissionCode: 'asset.audit.view',
    domainCode: 'asset',
    actionCode: 'view',
    description: 'Reserved — no audit read API exists yet.',
    riskLevel: 'medium',
